package main.java.org.extra06JPA;
...
public class InvoiceManager {
	...
	public Item createInvoiceItem(Invoice invoice, Integer id, String name,
	...
	public Item createItem(Integer id, String name, Float price,
			Integer quantity) {
		// TODO create new Item, set its properties and save it in database
	...
	public void clearData() {
		...
		entityTransaction.begin();
		em.createNativeQuery("delete from item; delete from invoice;")
				.executeUpdate();
		entityTransaction.commit();
	}
